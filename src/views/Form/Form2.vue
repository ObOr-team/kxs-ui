  ...
  <div id="total">
    <form id="basic" :model="formDemo"
        ...
        >
            ...
            年龄：
            <input style="width:200px" name="age" type="number" update:modelvalue.number="age"> <br/><br/>
            <div id="sex">
            性别： 男
            <input type="radio" name="sex1" update:modelvalue="sex" value="male"> 
            女
            <input type="radio" name="sex2" update:modelvalue="sex" value="female"></div>
            <br/>      
            <div id="hobby">
            爱好： 学习
            <input type="checkbox" update:modelvalue="hobby" value="study"> 打游戏
            <input type="checkbox" update:modelvalue="hobby" value="game"> 吃饭
            <input type="checkbox" update:modelvalue="hobby" value="eat">
            </div>
            <br/>
            <div id="location">
            位置：
