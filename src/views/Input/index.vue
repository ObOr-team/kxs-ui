<template>
  <div class="k-input">
    <span class="icon-right" v-if="rightIcon">
      <i :class="rightIcon"></i>
    </span>
...
export default {
  ...
  setup(props){
    ...
    return {changeEye,inputBox,eyeOpen}
  }
};
</script>
