...
<div class="people">
    <a href="https://github.com/Huangpeijin" target= "_blank">
        <img src="https://avatars.githubusercontent.com/u/116870542?v=4" alt=""/>
    </a>
...
.people a {
    animation: strink 0.2s 1 linear forwards;
}
.people img {
    width: 40px;
    height: 40px;
